...
module.exports = function(router) {
        ...
        // }
                      ...
                      if(!req.body && !req.files){
                        ...
                        Profile.findOne({user:req.body.id}).select('unique_id').exec(function(err,data){
                         ...
                         profile.save(function(err, Person){
                            if(err){
                              ...
                              console.log(err);
                                 ...
                                 res.json({ success: true, message: 'Account registered!', id:Person.user });
                                res.send('/');
                            }
        ...
        // }
                      ...
                      if(!req.body && !req.files){
                        res.json({success: false});
                         ...
                         documents.save(function(err, Person){
                            if(err){
                                res.json({ success: true, message:err });
                              console.log(err);
                            }
                                 ...
                                 res.json({ success: true, message: 'Account registered!', id:Person.user });
                                  res.sendFile(__dirname + "/generateActivation/kol="+Person.user);
                            }
    ...
    router.post('/setcar/:user_id', function(req, res) {
